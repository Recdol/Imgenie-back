...
class AuthService:
    ...
    def logged_in_user(self, access_token: str) -> User:
        payload: AccessTokenPayload = self._decode_access_token(access_token)
    ...
    def signin(self) -> tuple[str, str]:
        ...
        access_token = self._encode_access_token(AccessTokenPayload(user_id=user.id))
        refresh_token = self._encode_refresh_token(RefreshTokenPayload(user_id=user.id))
    ...
    def re_login(self, refresh_token: str) -> tuple[str, str]:
        ...
        new_refresh_token = self._encode_refresh_token(
    ...
    def _encode_access_token(self, payload: AccessTokenPayload) -> str:
    ...
    def _encode_refresh_token(self, payload: AccessTokenPayload) -> str:
